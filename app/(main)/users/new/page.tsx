...
import { Form, Input, Button, Select, Space, Card, message, Typography, TreeSelect, Layout } from 'antd';
...
const NewUserPage: React.FC = () => {
  ...
  return (
    <Layout style={{ minHeight: '100%', background: '#fff' }}>
      ...
      <Sider width={300} style={{ background: '#fff', borderLeft: '1px solid #f0f0f0', padding: 16 }}>
        ...
        <TreeSelect
          ...
          onChange={(value) => {
            form.setFieldsValue({ departmentIds: value });
          }}
          value={form.getFieldValue('departmentIds')}
        />
      </Sider>
    </Layout>
  );
